...
class Ui_New(object):
    def setupUi(self, Dialog):
        ...
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(0, 55, 200, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(0, 110, 200, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.optionsButton.setGeometry(QtCore.QRect(0, 250, 200, 25))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.optionsButton.setFont(font)
        self.optionsButton.setObjectName("optionsButton")
        self.quitButton = QtWidgets.QPushButton(Dialog)
        self.quitButton.setGeometry(QtCore.QRect(0, 275, 200, 35))
        font = QtGui.QFont()
        font.setPointSize(16)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_4.setText(_translate("Dialog", "Room Occupancy (Compared to full capacity):"))
